...
<body>
	...
	<div id='HistoricBox'>
	<c:forEach items="${historique}" var="choix" varStatus="vs">
    	<div class="choixHistorique">
    	<a class="TitreHistorique" href="read_story?idHist=${choix.idHist}&choix=${vs.index}&numParagPere=${current.numParag}">${choix.titre}</a>
    	<p>${choix.texte}</p>
    	</div>
    	<br>
	</c:forEach>
